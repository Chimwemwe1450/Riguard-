...
@Component({
  selector: 'app-ut-wall-views-step-two',
  templateUrl: './ut-wall-views-step-two.page.html',
  styleUrls: ['./ut-wall-views-step-two.page.scss'],
})
export class UtWallViewsStepTwoPage implements OnInit {
  ...
  public stepDescription = 'A Reading';
  ...
  private createForm() {
    ...
    this.form = this.fb.group({ readingA: this.rows });
    // this.addRow();
  }
