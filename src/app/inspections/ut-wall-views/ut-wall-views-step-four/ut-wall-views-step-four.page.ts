...
@Component({
  selector: 'app-ut-wall-views-step-four',
  templateUrl: './ut-wall-views-step-four.page.html',
  styleUrls: ['./ut-wall-views-step-four.page.scss'],
})
export class UtWallViewsStepFourPage implements OnInit {
  ...
  public stepDescription = 'C Reading';
  ...
  private createForm() {
    ...
    this.form = this.fb.group({ readingC: this.rows });
    // this.addRow();
  }
