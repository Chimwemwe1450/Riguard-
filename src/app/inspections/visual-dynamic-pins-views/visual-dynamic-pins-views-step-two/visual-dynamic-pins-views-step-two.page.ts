...
@Component({
  selector: 'app-visual-dynamic-pins-views-step-two',
  templateUrl: './visual-dynamic-pins-views-step-two.page.html',
  styleUrls: ['./visual-dynamic-pins-views-step-two.page.scss'],
})
export class VisualDynamicPinsViewsStepTwoPage implements OnInit {
