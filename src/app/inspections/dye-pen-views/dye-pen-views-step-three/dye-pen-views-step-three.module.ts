...
import { DyePenViewsStepThreePageRoutingModule } from './dye-pen-views-step-three-routing.module';
...
@NgModule({
  imports: [
    ...
    ReactiveFormsModule,
    IonicModule,
    DyePenViewsStepThreePageRoutingModule,
...
export class DyePenViewsStepThreePageModule {}
