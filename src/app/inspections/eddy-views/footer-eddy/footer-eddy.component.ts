...
@Component({
  selector: 'app-footer-eddy',
  templateUrl: './footer-eddy.component.html',
  styleUrls: ['./footer-eddy.component.scss'],
})
export class FooterEddyComponent implements OnInit {
  ...
  public async onSubmit(): Promise<void> {
    ...
    if (this.isFormValid) {
      this._eddyService.setFormAsComplete();
      this._eddyService.storePreviousData();
      ...
      await this._loadingService.presentLoading('Submitting Inspection...')
        .then(async () => {
          ...
          if (this.connection.status.connected) {
            // submit inspection.
            await this._eddyService.postInspectionData()
            .then((res: boolean) => {
              ...
              if (res) {
                ...
                this._eddyService.screenNavigation('exit', this.currentRoute);
  ...
  public onNext(): void {
    ...
    if (this.isFormValid) {
      this._eddyService.screenNavigation('next', this.currentRoute);
    } else {
  ...
  public onPrevious(): void {
    this._eddyService.screenNavigation('previous', this.currentRoute);
  ...
  private storeInspection(message: string): void {
    this._eddyService.storeInspectionData(this.currentRoute)
      .then(res => {
