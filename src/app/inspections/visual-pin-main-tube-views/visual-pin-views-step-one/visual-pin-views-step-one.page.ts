...
@Component({
  selector: 'app-visual-pin-views-step-one',
  templateUrl: './visual-pin-views-step-one.page.html',
  styleUrls: ['./visual-pin-views-step-one.page.scss'],
})
export class VisualPinViewsStepOnePage implements OnInit {
