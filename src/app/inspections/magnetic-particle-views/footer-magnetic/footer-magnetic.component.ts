...
@Component({
  selector: 'app-footer-magnetic',
  templateUrl: './footer-magnetic.component.html',
  styleUrls: ['./footer-magnetic.component.scss'],
})
export class FooterMagneticComponent implements OnInit {
  ...
  public async onSubmit(): Promise<void> {
    ...
    if (this.isFormValid) {
      this._magneticParticleService.setFormAsComplete();
      this._magneticParticleService.storePreviousData();
      ...
      await this._loadingService.presentLoading('Submitting Inspection...')
        .then(async () => {
          ...
          if (this.connection.status.connected) {
            // submit inspection.
            await this._magneticParticleService.postInspectionData()
            .then((res: boolean) => {
              ...
              if (res) {
                ...
                this._magneticParticleService.screenNavigation('exit', this.currentRoute);
  ...
  public onNext(): void {
    ...
    if (this.isFormValid) {
      this._magneticParticleService.screenNavigation('next', this.currentRoute);
    } else {
  ...
  public onPrevious(): void {
    this._magneticParticleService.screenNavigation('previous', this.currentRoute);
  ...
  private storeInspection(message: string): void {
    this._magneticParticleService.storeInspectionData(this.currentRoute)
      .then(res => {
