...
import { PostInspectionViewsStepEightPageRoutingModule } from './post-inspection-views-step-eight-routing.module';
...
@NgModule({
  imports: [
    ...
    ReactiveFormsModule,
    IonicModule,
    PostInspectionViewsStepEightPageRoutingModule,
...
export class PostInspectionViewsStepEightPageModule {}
